            ...
            <div>
                <div>
                    ...
                    <textarea
                        name="body"
                        v-model="body"
                        :class="{invalid: ($v.body.$dirty && (!$v.body.required || !$v.body.requiredIf || !$v.body.minLength))}"
                    >
                        {{ body }}
                    </textarea>
                    <div class="validation-email">
...
import {required, minLength, requiredIf, minValue, maxValue} from 'vuelidate/lib/validators';
