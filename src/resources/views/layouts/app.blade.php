        ...
        <div class="row">
            ...
            <div>
                <nav class="menu-list">
                    <div>
                        <ul>
                            <li><a class="{{ (request()->route()->getName() === 'tasks.index') ? 'active-url' : '' }}" href="{{ route('start.index') }}">Головна</a></li>
                            <li><a class="{{ (request()->route()->getName() === 'tasks.index') ? 'active-url' : '' }}" href="{{ route('issues.index') }}">Випуски</a></li>
                            <li><a class="{{ (request()->route()->getName() === 'tasks.index') ? 'active-url' : '' }}" href="{{ route('media.index') }}">Фото/Відео</a></li>
                            <li><a class="{{ (request()->route()->getName() === 'tasks.index') ? 'active-url' : '' }}" href="{{ route('states.index') }}">Статті</a></li>
                            <li><a class="{{ (request()->route()->getName() === 'tasks.index') ? 'active-url' : '' }}" href="{{ route('headings.index') }}">Рубрики</a></li>
                        </ul>
                    </div>
